class Ray {
  constructor(color, start_pos, end_pos, excitedBars, duration = 500) {
    this.color = color;
  ...
  _exciteElectron(barsToJump, fluorescence, duration = 3000, delay = 0) {
    ...
    let exciteTween = createTween(electron, firstElecPos, toGlobal(randBar), delay, duration);
